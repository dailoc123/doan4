...
<head>
    ...
    <title>Đăng nhập - Luxury Store</title>
...
<body class="min-h-screen fashion-bg flex items-center justify-center p-4">
            ...
            <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 text-sm">
                        ...
                        <a href="register.php" class="text-primary hover:text-secondary transition-colors duration-300 font-medium">Sign up</a>
                    </p>
                </div>
                ...
                <form action="auth/login.php" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="register.php"class="text-sm text-primary hover:text-secondary transition-colors duration-300">Forgot password?</a>
                    </div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <!-- Google -->
                    <a href="auth/login_google.php" class="flex items-center justify-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-300">
                        <i class="ri-google-fill text-xl text-red-500"></i>
                    </a>
                    <!-- Apple -->
                    <button class="flex items-center justify-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-300">
                        <i class="ri-apple-fill text-xl text-gray-800"></i>
                    </button>
                    <!-- Facebook -->
                    <a href="auth/login_facebook.php" class="flex items-center justify-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-300">
    ...
    <?php if (isset($_SESSION['error'])): ?>
        <div class="fixed top-4 right-4 bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 z-50">
